...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white fixed top-0 left-0 w-full h-full p-4">
          <div
          ...
          <div className="flex flex-col items-center gap-4 w-ful mt-10 text-black/80">
            ...
            {["Features", "Pricing", "Use cases"].map((item, index) => (
              <li
                key={index}
                className="w-full text-left py-4 px-6 bg-light-shade text-lg flex items-center justify-between rounded-md "
              >
                {item}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
